...
---
A hálózati eszközök gyári beállításainak visszaállításával kezdtem.
Az LTE antenna beállításával kezdtem. Megkapta a 192.168.88.1 IP címet illetve DHCP szerverként is üzemel ahol a címeket 192.168.88.100-192.168.88.250 osztja. Később a dátum is frissítésre került.
...
Itt az egyik egy Slave a másik pedig Master módban lett konfigurálva. Megkapták a 192.168.88.2 és a 192.168.88.3 címeket. A dátum és az idő illete a jelszó az előzőhöz hasonlóan itt is frissítve lett.
...
Itt pedig már  meg is kaptuk a címünket és kezdhettük a teszteléseket. 
...
![teszt utols2](https://github.com/user-attachments/assets/9951816f-384a-4cab-8b73-1865da7e26fe)
 ...
 Majd amikor mindennel készen lettem akkor megcsináltam a Draw.io alkalmazásban a topology ábrát.
 ![drawio](https://github.com/user-attachments/assets/2bdc2c88-f844-41f2-989c-7fff1da27aad)

 A feladat során több különböző hálózati eszköz és technológia alkalmazásával kellett egy működő rendszert létrehoznom, amely során számos kihívással kellett megküzdenem, de végül sikeresen teljesítettem a feladatot.

 Legközelebb nyugodtabban és több odafigyeléssel kell a feladatot elvégezni hiszen idő az bőven áll a rendelkezésemre. Több tesztelést is végre kell hajtani hogy biztosan ne legyen semmi probléma a hálózatunkkal.
